...
No non-shell file-reading mechanism is available in this session, so under your constraints I cannot safely inspect `src/iop/diffuse.c` to verify applicability or make the requested CPU-only edit without risking unintended changes.

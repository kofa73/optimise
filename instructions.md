...
Your PRIMARY OPTIMISATION TARGET is the preset "sharpen demosaicing / AA filter"; improve code paths that are triggered by using that preset. The definition of the preset can be found in src/iop/diffuse.c.
